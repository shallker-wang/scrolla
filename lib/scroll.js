...
module.exports = function Scroll(el) {
  ...
  var width, height, contentWidth, contentHeight, scrollTop;
  ...
  (function checkScrollTop() {
    if (scrollTop !== scroll.scrollTop) scroll.trigger('scrolling').trigger('scrolling-y');

    scrollTop = scroll.scrollTop;
    setTimeout(checkScrollTop, checkSizeInterval);
  })();
